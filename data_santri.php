...
<div class="p-4 sm:ml-64">
  <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
    ...
    <div class="mb-4">
      <a href="tambah_santri.php" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200">
      ...
      <table id="santriTable" class="w-full text-sm text-left text-gray-500">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 ">
          <tr>
            ...
            <th scope="col" class="px-6 py-3">Nomor Santri</th>
            <th scope="col" class="px-6 py-3">Kelas</th>
            <th scope="col" class="px-6 py-3">Tahun Ajaran</th>
            <th scope="col" class="px-6 py-3">Alamat</th>
            <th scope="col" class="px-6 py-3">Nama Wali</th>
        ...
        <tbody>
          ...
          ?>
            <tr class="bg-white border-b">
              ...
              <td class="px-6 py-4"><?= htmlspecialchars($row['nomor_santri']); ?></td>
              <td class="px-6 py-4"><?= htmlspecialchars($row['nama_kelas']); ?></td>
              <td class="px-6 py-4"><?= htmlspecialchars($row['tahun_ajaran']); ?></td>
              <td class="px-6 py-4"><?= htmlspecialchars($row['alamat'] ?? '-'); ?></td>
              <td class="px-6 py-4"><?= htmlspecialchars($row['nama_wali']); ?></td>
              <td class="px-6 py-4 text-center">
                <a href="edit_santri.php?id=<?= $row['id_siswa']; ?>" class="text-blue-600 dark:text-blue-400 hover:underline mr-2">
                  <i class="fas fa-edit"></i> Edit
                </a>
                <a href="hapus_santri.php?id=<?= $row['id_siswa']; ?>" class="text-red-600 dark:text-red-400 hover:underline">
