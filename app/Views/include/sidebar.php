<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-slate-100 sm:translate-x-0 shadow-[4px_0_24px_rgba(0,0,0,0.02)]" aria-label="Sidebar">
  <div class="h-full px-4 pb-4 overflow-y-auto bg-white">
    ...
    <ul class="space-y-1.5 font-medium">
      ...
      <li>
        <a href="data_arsip_santri.php" class="flex items-center p-3 rounded-xl transition-all duration-200 group <?php echo ($currentPage == 'data_arsip_santri.php') ? 'bg-emerald-50 text-emerald-700' : 'text-slate-600 hover:bg-slate-50 hover:text-emerald-600'; ?>">
      ...
      <li>
        <a href="penilaian_mapel.php" class="flex items-center p-3 rounded-xl transition-all duration-200 group <?php echo ($currentPage == 'penilaian_mapel.php') ? 'bg-emerald-50 text-emerald-700' : 'text-slate-600 hover:bg-slate-50 hover:text-emerald-600'; ?>">
      ...
      <li>
        <a href="evaluasi_wali.php" class="flex items-center p-3 rounded-xl transition-all duration-200 group <?php echo ($currentPage == 'evaluasi_wali.php') ? 'bg-emerald-50 text-emerald-700' : 'text-slate-600 hover:bg-slate-50 hover:text-emerald-600'; ?>">
      ...
      <li>
        <a href="identitas_madrasah.php" class="flex items-center p-3 rounded-xl transition-all duration-200 group <?php echo ($currentPage == 'identitas_madrasah.php') ? 'bg-emerald-50 text-emerald-700' : 'text-slate-600 hover:bg-slate-50 hover:text-emerald-600'; ?>">
      ...
      <li>
        <a href="data_guru.php" class="flex items-center p-3 rounded-xl transition-all duration-200 group <?php echo ($currentPage == 'data_guru.php') ? 'bg-emerald-50 text-emerald-700' : 'text-slate-600 hover:bg-slate-50 hover:text-emerald-600'; ?>">
      ...
      <li>
        <a href="kenaikan_kelas.php" class="flex items-center p-3 rounded-xl transition-all duration-200 group <?php echo ($currentPage == 'kenaikan_kelas.php') ? 'bg-emerald-50 text-emerald-700' : 'text-slate-600 hover:bg-slate-50 hover:text-emerald-600'; ?>">
      ...
      <?php if ($_SESSION['peran'] === 'Admin'): ?>
      <li>
        <a href="log_aktivitas.php" class="flex items-center p-3 rounded-xl transition-all duration-200 group <?php echo ($currentPage == 'log_aktivitas.php') ? 'bg-emerald-50 text-emerald-700' : 'text-slate-600 hover:bg-slate-50 hover:text-emerald-600'; ?>">
