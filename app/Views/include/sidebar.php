<aside id="logo-sidebar" hx-indicator="#page-loader" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-slate-200 sm:translate-x-0" aria-label="Sidebar">
  <div class="h-full px-4 pb-4 overflow-y-auto bg-white">
    ...
    <!-- Quick Help Banner -->
    <div class="mt-8 p-4 bg-emerald-50 rounded-xl border border-emerald-100 relative overflow-hidden group">
        <div class="absolute -right-4 -bottom-4 opacity-10">
            <i class="ri-customer-service-2-fill text-8xl text-emerald-600"></i>
        </div>
        <div class="relative z-10">
            <h4 class="text-sm font-bold text-emerald-900 mb-1">Butuh Bantuan?</h4>
            <p class="text-xs text-emerald-700 mb-3">Hubungi admin jika Anda mengalami kendala.</p>
            <a href="#" class="inline-flex items-center justify-center w-full px-3 py-2 text-xs font-bold text-white bg-emerald-600 rounded-lg hover:bg-emerald-700 transition-colors">
                Kontak Admin
            </a>
        </div>
    </div>
