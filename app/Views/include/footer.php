...
<nav class="sm:hidden fixed bottom-4 left-4 right-4 z-50 p-[2px] nav-glow shadow-[0_8px_30px_rgb(0,0,0,0.08)] rounded-full transition-all">
    <div class="w-full bg-white/90 backdrop-blur-md rounded-full px-2 py-2 flex justify-between items-center">
        <!-- Tab: Dashboard -->
