...
<body>
    ...
    ?>
	    <div class="page" style="padding:0 !important;">
	        ...
	        <!-- SPACER -->
	        <div style="display:table-row;">
	            <div style="display:table-cell; border:none; padding:0; height:100px;"></div>
	        </div>
	        ...
	        <div style="display:table-row;">
	            <div style="display:table-cell; text-align:center; vertical-align:middle; border:none; padding:0;">
	                ...
	                ?>
	                <?php if ($logoExists): ?>
	                    <img src="<?= $logoSrc ?>" alt="Logo" style="max-width:150px; max-height:150px; margin:10px auto;">
	                <?php else: ?>
	                ...
	                <h1 style="margin:20px 0 10px 0;"><?= htmlspecialchars($identitas['nama_madrasah'] ?? 'MADRASAH DINIYAH SALAFIYAH AL FALAHIYAH') ?></h1>
	                <p style="margin:5px 0;">NSMD : <?= htmlspecialchars($identitas['nsmd'] ?? '321 235 240 013') ?> &nbsp;&nbsp;&nbsp; NPSN : <?= htmlspecialchars($identitas['npsn'] ?? '') ?></p>
	                <p style="margin:5px 0;"><?= htmlspecialchars($identitas['alamat'] ?? 'Ngepung Rejosari Deket Lamongan') ?></p>
	            </div>
	        </div>
