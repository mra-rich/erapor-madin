...
<div id="offcanvas-import-kelas" class="fixed inset-y-0 right-0 z-50 w-full md:w-[450px] bg-white shadow-2xl transform translate-x-full transition-transform duration-300 ease-in-out flex flex-col">
    ...
    <div class="p-6 flex-1 overflow-y-auto flex flex-col items-center" id="import-kelas-step-1">
        <a href="download_template_kelas.php" target="_blank" hx-disable hx-boost="false" class="w-full inline-flex items-center justify-center px-4 py-3 mb-6 bg-emerald-50 text-emerald-700 hover:bg-emerald-100 font-medium rounded-xl transition-colors duration-200 shadow-sm border border-emerald-200" download>
