            ...
            <div class="p-6">
                ...
                <form action="proses_edit_kelas" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <select name="id_tingkat" id="id_tingkat" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-3 transition-colors" required>
                            ...
                            <?php while ($t = mysqli_fetch_assoc($tingkat_result)): ?>
                                <option value="<?php echo $t['id_tingkat']; ?>" <?php echo ($kelas['id_tingkat'] == $t['id_tingkat']) ? 'selected' : ''; ?>>
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_rombel" id="nama_rombel" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-3 transition-colors" value="<?php echo htmlspecialchars($kelas['nama_rombel']); ?>" required>
                    </div>

                    <div>
                        <label class="block mb-2 text-sm font-semibold text-gray-900">Nama Tampilan (Lengkap) <span class="text-red-500">*</span></label>
                        <input type="text" name="nama_kelas" id="nama_kelas" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-3 transition-colors" value="<?php echo htmlspecialchars($kelas['nama_kelas']); ?>" required>
                    </div>
