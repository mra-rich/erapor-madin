            ...
            <div class="header-info">
                <table class="info-table">
                    <tr>
                        ...
                        <td class="info-value nama-santri">: </td>
                        <td class="info-label">Kelas</td>
                        <td class="info-value kelas">: </td>
                    </tr>
                    <tr>
                        <td class="info-label">Nomor Induk</td>
                        <td class="info-value nomor-induk">: </td>
                        <td class="info-label">Tahun Pelajaran</td>
                        <td class="info-value tahun-pelajaran">: </td>
                    </tr>
                </table>
            </div>
            <!--  -->
...
<script>
    ...
    async function tampilkanNilai(nilai, container) {
        ...
        row.innerHTML = `
            ...
            <td class="output-mapel-arab arabic">${nilai.nama_mapel_arab}</td>
        ...
        if (siswa) {
            ...
            try {
                ...
                const response = await fetch('get_siswa_rapot.php', {
                    ...
                    body: 'siswa=' + siswa + '&semester=' + semester
                });
    ...
    function cetakPDF() {
        ...
        const elementsToHide = document.querySelectorAll('.p-4.sm\\:ml-64 > .p-4.border-2 > *:not(#laporan-container)');
        ...
        // Set proper styling for printing
    ...
    function cetakWord() {
        ...
        // Get styles to include in the Word document
        const style = document.querySelector('style').textContent;

        // Create HTML content for Word file
        const html = `
        ...
        <head>
            ...
            <style>
                ${style}
                /* Additional styles for better Word formatting */
                @page {
                    size: A4;
                    margin: 1cm;
                }
    ...
    `;
        ...
        const namaSantri = document.querySelector('.nama-santri').textContent.replace(': ', '').trim();
        const kelas = document.querySelector('.kelas').textContent.replace(': ', '').trim();
        link.download = `Laporan_${namaSantri}_${kelas}.doc`;
    ...
    // Function to handle HTML content in Word document
    function convertToWord(htmlContent) {
        ...
        const link = document.createElement('a');
        link.href = url;
        link.download = 'Laporan_Hasil_Belajar.doc';
        document.body.appendChild(link);
        link.click();
        document.body.removeChild(link);
