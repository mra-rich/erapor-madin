...
<div class="p-4 sm:ml-64">
  <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
    ...
    <!-- Tombol Tambah Kelas -->
    <div class="mb-4">
      <a href="tambah_kelas.php" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200">
        ...
        <tbody>
          ...
          ?>
            <tr class="bg-white border-b">
              ...
              <td class="px-6 py-4 font-medium"><?= htmlspecialchars($row['nama_kelas']); ?></td>
              <td class="px-6 py-4"><?= htmlspecialchars($row['tingkat']); ?></td>
              <td class="px-6 py-4"><?= htmlspecialchars($row['nama_wali_kelas']); ?></td>
              <td class="px-6 py-4 text-center">
                <a href="edit_kelas.php?id=<?= $row['id_kelas']; ?>" class="text-blue-600 dark:text-blue-400 hover:underline mr-2">
                  <i class="fas fa-edit"></i> Edit
                </a>
                <a href="hapus_kelas.php?id=<?= $row['id_kelas']; ?>" class="text-red-600 dark:text-red-400 hover:underline" onclick="return confirm('Yakin ingin menghapus data ini?');">
